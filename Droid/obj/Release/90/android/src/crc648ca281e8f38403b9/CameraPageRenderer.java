...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CustomRenderer.Droid.CameraPageRenderer, CustomRenderer.Droid", CameraPageRenderer.class, __md_methods);
	}
	...
	public CameraPageRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		...
		if (getClass () == CameraPageRenderer.class)
			mono.android.TypeManager.Activate ("CustomRenderer.Droid.CameraPageRenderer, CustomRenderer.Droid", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
	...
	public CameraPageRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == CameraPageRenderer.class)
			mono.android.TypeManager.Activate ("CustomRenderer.Droid.CameraPageRenderer, CustomRenderer.Droid", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
	...
	public CameraPageRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == CameraPageRenderer.class)
			mono.android.TypeManager.Activate ("CustomRenderer.Droid.CameraPageRenderer, CustomRenderer.Droid", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
